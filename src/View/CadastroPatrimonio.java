 ...
 * @author Leandro Melo
 */
public class CadastroPatrimonio extends javax.swing.JInternalFrame {
    ...
    public CadastroPatrimonio() {
        ...
        label_gb1.setForeground(Color.gray);
        label_gb2.setForeground(Color.gray);
    ...
    */
    ...
    // Validações para o botão cadastrar.
    private void botao_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_cadastrarActionPerformed
        if (!soTemNumeros(campo_numTombamento.getText())) {
            ...
            JOptionPane.showMessageDialog(this, "POR FAVOR DIGITE APENAS NÚMEROS \n"
                                              + "NO CAMPO Nº Tombamento", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, "Nº DE TOMBAMENTO INCORRETO!\n"
                                              + "POR FAVOR INFORME UM NÚMERO COM 5 DÍGITOS", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            campo_numTombamento.requestFocus();
        } else if (campo_numTombamento.getText().equalsIgnoreCase("00000")){
            label_tombamento.setForeground(Color.red);
            JOptionPane.showMessageDialog(this, "NÚMERO DE TOMBAMENTO NÃO PERMITIDO!!!", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            campo_numTombamento.requestFocus();
            ...
            JOptionPane.showMessageDialog(this, "NÚMERO DE TOMBAMENTO JÁ EXISTE "
                                              + "\nPOR FAVOR VERIFIQUE E DIGITE NOVAMENTE", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            campo_numTombamento.requestFocus();
        } else {
            if (cbPc.isSelected()) {
                if((cbSetores.getSelectedIndex() == 0) && cbUserName.getSelectedIndex() == 0){
                    ...
                    JOptionPane.showMessageDialog(this, "SELECIONE UM SETOR E UM USUÁRIO PARA CONTINUAR", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(this, "SELECIONE UM USUÁRIO PARA CONTINUAR", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
    ...
    private void cbPcStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_cbPcStateChanged
        if (cbPc.isSelected()) {
            ...
            label_gb1.setForeground(Color.black);
            label_gb2.setForeground(Color.black);
        } else {
            cbUserName.setEnabled(false);
            campo_processador.setEnabled(false);
            campo_hd.setEnabled(false);
    ...
    // Verificação do que foi digitado no campo numTombamento.
