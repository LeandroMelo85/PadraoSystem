 ...
 * @author Leandro Melo
 *
 * O objetivo dessa classe é apenas criar uma senha criptografada para ser gravada 
 * diretamente no banco enquanto essa função não é implementada no sistema
 * 
 */
